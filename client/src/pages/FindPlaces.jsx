...
export default function FindPlacePage() {
    ...
    if (!ready) return <h1 className="px-10 sm:px-20 pt-3 font-semibold text-xl">Đang tìm kiếm...</h1>;

    return (
        <div>
            <h1 className="px-10 md:px-20 pt-3 font-semibold text-xl">
                Có {places.length} khách sạn &quot;{query}&quot; tìm được
            </h1>
                    ...
                    places.map((place) => (
                        <Link to={'/place/' + place._id} key={place._id}>
                            <div className="border-2 p-4 rounded-xl shadow-lg">
                                ...
                                <div className="h-24">
                                    <h2 className="font-bold overflow-hidden text-ellipsis">{place.title}</h2>
            ...
            {places.length === 0 && (
                <div className="">
                    <img
                        ...
                        alt=""
                    />
                    <h1 className="text-center text-4xl font-semibold">Không tìm thấy!</h1>
                </div>
            )}
        </div>
    );
