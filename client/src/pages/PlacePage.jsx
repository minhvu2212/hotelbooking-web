    ...
    return (
        <div className="pt-3 rounded-2xl md:w-full lg:w-2/3 m-auto px-10">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-semibold text-primary">{place.title}</h1>
                    <div className="flex items-end py-2">
                        <span className="material-symbols-outlined text-2xl pr-1 text-primary">star</span>
                        {rate !== 0 && <h1 className="text-2xl font-semibold text-primary">{rate.toPrecision(2)}</h1>}
                        {rate === 0 && <h1 className="text-2xl font-semibold text-primary">-</h1>}
                        <h1 className="text-xl text-gray-400 text-primary">/5</h1>
                        <h1 className="font-semibold px-1 text-primary"> - {feedbacks.length} nhận xét</h1>
                    </div>
                </div>
            ...
            <div className="mt-8 mb-8 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr]">
                <div>
                    <div className="my-4">
                        <h2 className="font-semibold text-2xl text-primary">Thông tin chi tiết</h2>
                        {place.description}
                    </div>
                    ...
                    <br />
                    Số khách tối đa: {place.maxGuests}
                    <br />
                    Tính năng:
            ...
            <div className="bg-white -mx-8 px-8 py-8 border-t">
                <div>
                    <h2 className="font-semibold text-2xl text-primary">Thông tin thêm</h2>
                </div>
                <div className="mb-4 mt-2 text-sm text-gray-700 leading-5">{place.extraInfo}</div>
            </div>
            <div className="bg-white -mx-8 px-8 py-8 border-t">
                <div>
                    <h2 className="font-semibold text-2xl text-primary">Nhận xét từ khách hàng</h2>
                    <div className="flex items-end py-2">
                        <span className="material-symbols-outlined text-2xl pr-1">star</span>
                        {rate !== 0 && <h1 className="text-2xl font-semibold">{rate.toPrecision(2)}</h1>}
                                ...
                                <div key={feedback._id} className="py-5">
                                    <div className="flex">
                                        ...
                                        <div className="pl-3">
                                            ...
                                            <h1 className="text-sm text-gray-500">{feedback.user.email}</h1>
                                            <Rate rating={feedback.rate} />
                                            <h1 className="text-gray-500 text-sm">{formatDate(feedback.date)}</h1>
                                        </div>
                                    </div>
                                    <div className="pt-5">
