...
export default function WishlistPage() {
    ...
    async function removeWishlist(ev, place) {
        ...
        setPlaces((prevPlaces) => prevPlaces.filter((item) => item.place._id !== place._id));
    }
    ...
    if (!ready)
        return (
            <div>
                <AccountNav />
                <h1 className="text-center text-3xl font-semibold my-20">Đang tải...!</h1>
            </div>
        );
    ...
    return (
        <div>
            <AccountNav />
            {places.length === 0 && (
                <h1 className="text-center text-3xl font-semibold my-20">Let&apos;s add hotels to your wishlist !!!</h1>
            )}
                            ...
                            <div className="border p-4 rounded-xl shadow-lg border-primary">
                                <Link to={'/place/' + doc.place._id}>
                                    ...
                                    <div className="h-24">
                                        ...
                                        <br />
                                        <h3 className="text-sm ">{doc.place.address}</h3>
                                    </div>
                                </Link>
